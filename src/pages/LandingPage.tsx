...
const LandingPage = () => {
    ...
    return (
        <div className="bg-dark text-paper min-h-screen font-sans selection:bg-bordo selection:text-gold">
            {/* Hero Section */}
            <section ref={targetRef} className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <motion.h1 
                        className="text-6xl md:text-9xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-gold to-yellow-700 mb-6"
                    ...
                    <motion.p 
                        className="text-xl md:text-2xl text-gray-400 font-light tracking-widest uppercase max-w-lg"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.8, duration: 1 }}
                    >
                        The Eye of the Digital Dojo
                    </motion.p>
                </motion.div>
                ...
                >
                    <ChevronDown className="w-8 h-8 text-gold/50 animate-bounce" />
                </motion.div>
            </section>
            ...
            <section className="relative z-10 bg-dark">
                <FadeInSection>
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1">
                            <h2 className="text-4xl md:text-6xl font-bold text-paper mb-6">Precision & <span className="text-bordo">Power</span>.</h2>
                        ...
                        <div className="flex-1 h-64 md:h-96 bg-gray-900 rounded-2xl overflow-hidden border border-white/5 relative group">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center text-gold/20 font-serif text-9xl">侍</div>
                        </div>
                    </div>
                </FadeInSection>
                ...
                <FadeInSection>
                    <div className="flex flex-col md:flex-row-reverse items-center gap-12">
                        <div className="flex-1">
                            <h2 className="text-4xl md:text-6xl font-bold text-paper mb-6">Seamless <span className="text-gold">Structure</span>.</h2>
                            <p className="text-xl text-gray-400 leading-relaxed">
                ...
                <FadeInSection>
                     <div className="text-center py-20">
                        ...
                        <button
                            ...
                            className="group relative inline-flex items-center justify-center px-12 py-4 overflow-hidden font-bold text-white transition-all duration-300 bg-transparent border-2 border-gold rounded-full hover:bg-gold/10 focus:outline-none"
                        >
